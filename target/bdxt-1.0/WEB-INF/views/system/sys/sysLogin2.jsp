...
<body>
	...
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://git.oschina.net/zdw2016/webbase5" target="_blank">Webbase</a> ${fns:getConfig('version')}
	</div>
