...
<head>
	...
	<script src="${ctxStatic}/weixin/wxPic/wxLocalPicForm.js" type="text/javascript"></script>
	<script src="${ctxStatic}/ckeditor/ckeditor.js" type="text/javascript"></script>
</head>
<body>
<div ng-app="myApp" ng-controller="WxImageAddCtrl">
    <ul class="nav nav-tabs">
		<shiro:hasPermission name="weixin:wxMaterialNews:view"><li><a href="${ctx}/wxnewsmsg/wxNewsMsg/locallist?accountid=${accountId}" style="color: #157ab5;">图文管理列表</a></li></shiro:hasPermission>
		<li class="active"><a href="${ctx}/wxnewsmsg/wxNewsMsg/form/?accountid=${accountId}">本地图文{{id?'编辑':'新增'}}</a></li>
	</ul>
    <div class="wrapper-md">
        ...
        <div class="col span4">
                ...
                <div class="form-actions form-oprate m-b m-t" style="clear:both;text-align:center;padding-left:0px;">
                    ...
                    <a href="${ctx}/wxnewsmsg/wxNewsMsg/locallist?accountid=${accountId}" class="btn">取消</a>
                </div>
            </div>
             ...
             <!--    <div class="form-group">
                     ...
                     <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="clear">
                            <input type="text" class="form-control wxtext" ng-model="currentMate.url">
                        </div>
                    </div> 
