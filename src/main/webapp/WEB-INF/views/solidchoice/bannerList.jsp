...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="sys:banner:edit">
        <li><a href="${ctx}/sys/banner/form">字典信息添加</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="banner" action="${ctx}/sys/banner/" method="post"
        ...
        <tr>
            ...
            <shiro:hasPermission name="sys:banner:edit">
                <td>
                    ...
                    <a href="${ctx}/sys/banner/delete?id=${banner.id}"
