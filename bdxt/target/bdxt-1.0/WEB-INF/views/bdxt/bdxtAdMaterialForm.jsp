...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/bdxt/bdxtAdMaterial/">广告素材列表</a></li>
    <li class="active"><a href="${ctx}/bdxt/bdxtAdMaterial/form?id=${bdxtAdMaterial.id}">广告素材<shiro:hasPermission
            name="bdxt:bdxtAdMaterial:edit">${not empty bdxtAdMaterial.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="bdxt:bdxtAdMaterial:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="bdxtAdMaterial" action="${ctx}/bdxt/bdxtAdMaterial/save" method="post"
    ...
    <div class="control-group">
        <label class="control-label"><span class="red">*</span>素材类型：</label>
        <div class="controls">
            <form:select path="type" class="input-medium ">
                <form:option value="">请选择</form:option>
                <form:options items="${fns:getDictList('bdxt_ad_material')}" itemLabel="label" itemValue="id"
                              htmlEscape="false"/>
            </form:select>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">目标群体：</label>
        <div class="controls">
            <form:select path="sex" class="input-medium">
                <form:option value="中国">中国</form:option>
                <form:options items="${fns:getDistrictList('3000336','中国')}" itemLabel="districtname"
                              itemValue="districtname" htmlEscape="false"/>
            </form:select>
        </div>
    </div>
    ...
    <div class="control-group">
        <label class="control-label"><span class="red">*</span>跳转链接：</label>
        <div class="controls">
    ...
    <div class="control-group">
        ...
        <div class="controls" style="position: relative;height: 33px">
            <input id="uploaderInput" name="files" class="input-xlarge" type="file" multiple
                   style="opacity: 0;position: absolute;z-index: 999;width: 100%"/>

            <div style="height: 30px;position: absolute;top: 0px;display: flex;justify-content: flex-end;
    align-items: center;width: 27.5%;border: 1px solid #ccc;border-radius: 5px;padding-right: 10px;z-index: 1;cursor: pointer">
                选择
            </div>
        </div>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="bdxt:bdxtAdMaterial:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"
                                                                    value="保 存"/>&nbsp;</shiro:hasPermission>
        <input id="btnCancel" class="btn" type="button" value="返 回"
               onclick="window.location.href='${ctx}/bdxt/bdxtAdMaterial'"/>
    </div>
</form:form>
</body>
</html>