 ...
 */
package com.foreveross.webbase.system.gen.web;
...
import com.foreveross.webbase.system.gen.service.GenSchemeService;
import com.foreveross.webbase.system.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String list(GenScheme genScheme, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "system/gen/genSchemeList";
	}
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.foreveross.webbase.system");
		}
...
//		}
		...
		return "system/gen/genSchemeForm";
	}
