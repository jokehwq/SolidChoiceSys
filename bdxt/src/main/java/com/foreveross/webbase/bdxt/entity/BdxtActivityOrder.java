 ...
 * @version 2018-02-03
 */
public class BdxtActivityOrder extends DataEntity<BdxtActivityOrder> {
	...
	public BdxtActivityOrder() {
		super();
	}


	public BdxtActivityOrder(String activityId,
							 Integer orderStatus ){
	...
	public BdxtActivityOrder(String id){
		super(id);
	}
