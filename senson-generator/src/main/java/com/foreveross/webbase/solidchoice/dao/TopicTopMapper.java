...
import com.foreveross.webbase.solidchoice.entity.TopicTop;
import com.foreveross.webbase.solidchoice.entity.TopicTopExample;
...
public interface TopicTopMapper {
     ...
     * @mbggenerated Thu Sep 06 10:11:00 CST 2018
     */
    List<TopicTop> selectByExampleWithBLOBs(TopicTopExample example);
     ...
     * @mbggenerated Thu Sep 06 10:11:00 CST 2018
     */
    int updateByExampleWithBLOBs(@Param("record") TopicTop record, @Param("example") TopicTopExample example);
     ...
     * @mbggenerated Thu Sep 06 10:11:00 CST 2018
     */
    int updateByPrimaryKeyWithBLOBs(TopicTop record);
